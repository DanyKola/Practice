...
import com.example.demo.db.mapper.CustomerRowMapper;
    ...
    public Integer add(Customer customer) {
        ...
        jdbcTemplate.update(new PreparedStatementCreator() {
            ...
            public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
                PreparedStatement ps = con.prepareStatement(sql, PreparedStatement.RETURN_GENERATED_KEYS);//vrátí také klíč
        ...
        }, keyHolder); //(dát druhý parametr keyholder
